---
title: "Digital Guard - Diagnóstico 'Operação'"
...
Revisar modelo do README e escrever manual para preenchimento do README, que também poderia ser feito utilizando formulário.

### 7) Manual yaml {#manual-yaml}

Escrever manual yaml.
