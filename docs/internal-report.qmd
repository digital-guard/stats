...
4) [Manual sha256sum](#manual-sha256sum). Subir os arquivos para o servidor da preservação.

5) [Manual README](#manual-readme). Para filtragem dos dados.

6) [Manual yaml](#manual-yaml) Para filtragem dos dados.
